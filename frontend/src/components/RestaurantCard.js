...
import {Box, Button, Card, CardActionArea, CardContent, Rating, Stack, Typography} from "@mui/material";
        ...
        {isAdmin && (
          <Button
            ...
            sx={{
              ...
              width: "100%",
              fontSize: "14px",
              mb: (userRole !== "ADMIN" || (typeof restaurant.approved !== 'boolean' || restaurant.approved)) ? 0 : 1
            }}
          >
            Delete Restaurant
          </Button>
          ...
          <Box sx={{display: 'flex', justifyContent: 'space-between', width: '100%'}}>
            ...
            <Button
              ...
              sx={{
                ...
                width: "48%",
                fontSize: "14px",
                "&:hover": {borderColor: "#F44336", backgroundColor: "#F44336", color: "white"}
              }}
            >
              Reject
            </Button>
                      ...
                      return (
                        ...
                        >
                          <Button size="small" variant="outlined"
                                  sx={{borderRadius: "20px", textTransform: "none", width: "100%"}}>
                            {startTime}
                          </Button>
                        </Link>
                      );
