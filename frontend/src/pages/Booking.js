    ...
    <Container maxWidth="sm" sx={{mt: 4}}>
      <Paper elevation={3} sx={{p: 3}}>
        ...
        <Box sx={{my: 2}}>
          ...
          <Typography
            color="text.secondary">{restaurantDetails.addressStreet}, {restaurantDetails.addressCity}</Typography>
        ...
        {bookingStatus === 'failed' && bookingError && <Alert severity="error"
                                                              sx={{my: 2}}>{typeof bookingError === 'string' ? bookingError : 'Booking failed.'}</Alert>}
